...
import { HOST, LOGOUTROUTE } from '@/utils/constants';
...
const ProfileInfoComponent = () => {
    ...
    const logOut = async () => {
        try {
            const response = await apiClient.post(LOGOUTROUTE,{}, {withCredentials:true});
      ...
      <div className="flex gap-5">
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent className='bg-[#1c1b1e] border-none text-white p-1'>
              Logout
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
